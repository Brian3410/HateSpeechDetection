...
def train_model():
    ...
    print("🚀 Starting Enhanced DistilBERT Training with POS Features for Hate Speech Detection")
    print("=" * 80)
    ...
    if Config.USE_POS_FEATURES:
        ...
        print("✅ Using standard DistilBERT")
    ...
    print("\n" + "="*60)
    print("🎉 ENHANCED DISTILBERT WITH POS FEATURES TRAINING COMPLETED!")
    print("="*60)
