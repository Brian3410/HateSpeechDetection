...
def train_model():
    """Enhanced training function for DistilBERT with imbalance handling."""
    print("Starting Enhanced DistilBERT Training for Hate Speech Detection with Imbalance Handling")
    print("=" * 80)
    ...
    print("\n" + "="*60)
    print("✅ ENHANCED DISTILBERT TRAINING WITH IMBALANCE HANDLING COMPLETED!")
    print("="*60)
