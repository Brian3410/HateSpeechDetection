...
# Set NLTK data path
nltk_data_path = "/scratch/ml23/bnge/roberta/nltk_data"
...
class Config:
    ...
    MODEL_OUTPUT_DIR = "robertat_survey_augmentation_model"
...
def train_model():
    ...
    with open(report_path, 'w') as f:
        f.write("RoBERTa with Survey-Based Data Augmentation - Hate Speech Detection Results\n")
        f.write("=" * 80 + "\n\n")
